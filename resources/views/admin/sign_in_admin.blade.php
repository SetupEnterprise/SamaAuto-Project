@extends('layouts/auth',['title' => 'Authentification Administrateur'])
	...
	<div id="corps-ins">
		...
		<div id="contenu">
  	    ...
  	    <div id='form-inscription'>
			<form action="{{ route('admin_authStore') }}" method="POST">
				{{ csrf_field() }}

				<h5 style="color: greenyellow;text-align: center;font-family: Arial, San-Serif;margin-top : 23%;margin-bottom: 10%; font-weight: bold;">Authentification Admin SamaAuto</h5>
